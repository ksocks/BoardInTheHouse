...
(function() {
  ...
  */
  ...
  canvas.addEventListener('pointerleave', onMouseUp, false);
  ...
  function onMouseUp(e){
    if (!drawing) { return; }
    drawing = false;
    var linewidth = e.pressure ? e.pressure * 8 : 4;
    drawLine(current.x, current.y, e.clientX||e.touches[0].clientX, e.clientY||e.touches[0].clientY, current.color, linewidth, true);
  }
